...
public class DataBaseHandler extends SQLiteOpenHelper {
    ...
    {
        // creating tables like registeruser, topics, tests, questions, and reports.
    ...
    // Add user to the register user table
    ...
    // get the tests from the tests table
    ...
    // getting test record by subject and user
    ...
    // getting topicName from topics table
    ...
    // getting TestsIds from test table
    ...
    // checking the user credentials presenting in the registeruser table
    ...
    // get email for registeruser table
    ...
    // update the email of user in the register user table
    ...
    // udpate password in the registeruser table
    ...
    // getpassword from registeruser table
    ...
    // deleting the test record from tests table
    ...
    // adding reports to the reports table
    ...
    // getting the report record from the reports table
