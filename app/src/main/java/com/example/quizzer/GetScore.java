...
public class GetScore extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // setting an adapter for listview
       CustomAdapter customadapter=new CustomAdapter();
       listview.setAdapter(customadapter);
       returnMenu.setOnClickListener(new View.OnClickListener() {
           @Override
           public void onClick(View v) {
                // calling the UserDashboard on click of returnMenu button
        ...
        // add reports to the database using addReports method
    ...
    public void onBackPressed() {
        // on back pressed do nothing
    }
    // setting a custom adapter for listview
