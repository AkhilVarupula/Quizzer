...
protected void onCreate(Bundle SavedInstanceState) {
    ...
    // getting the views of username,password,signup and login
    ...
    //setting an onclicklistener on signup buttong
    ...
    //checking the usercredentials when user presses login button
...
// creating a session on user login
    @Override
    public void onStart() {
        super.onStart();
        SessionManagement sessionManagement = new SessionManagement(LoginActivity.this);
