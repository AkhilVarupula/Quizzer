...
public class SetupQuestionPaper extends AppCompatActivity {
    ...
    // increase the question count and validating the end of questions in teh question paper
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // getting the reference views of the widges in the activity_setup_question_paper layout
        ...
        // Moving to the next question on clicking of next button
            ...
            public void onClick(View v) {
                ...
                if(validate_insert(getQuestion,getOption1,getOption2,getOption3,getOption4,getCorrectAnswer)) {
                    for (int i = 0; i < arraylist.size(); i++) {
                        // adding questions to the questions table in the database
        ...
        // returing to the admindashboard on clicking on the exit button
    ...
    // Validating question and options editboxes to make sure they are not empty
