...
public class UserQuestionPaper extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // Log.e("array",array.toString());
        ...
        // Settin the count and score to zero
        count=0;
        score=0;
        //array.get(count);
        ...
        if(array.get(count)!=null) {
            ...
            // setting up the question and choices in the their respective textviews
        ...
        // Changing the options and questions whenever user clicks on next button
    ...
    // Called when the textview text needed to be changed whenever user clicks on next button
...
// Set timer for duration specified
    ...
    // Do nothing on click of back button
    @Override
