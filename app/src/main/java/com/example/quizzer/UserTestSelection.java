...
public class UserTestSelection extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // putting the ids of test in the spinner using a customadapter
        ...
        // on click of item in the testspinner get the id of it
        ...
        // click on start button move to userQuizStart page
